...
namespace Infrastructure.StateMachine
{
    public class BootstrapState : IState
    {
        ...
        public void Enter()
        {
            ...
            _sceneLoader.Load(SceneNameCOnstants.InitialSceneName, EnterLoadLevelState);
...
//            _services.Single<IFactories>().Single<IAudioFactory>().CreateSoundSource();
        ...
        private void RegisterServices()
        {
            ...
            _services.RegisterSingle<IAudioService>(new AudioService(_services.Single<IFactories>(),
                _services.Single<IStaticDataService>()));

            _services.Single<IFactories>().Add<IInputFactory>(new InputFactory(_services.Single<IAudioService>(),
                _services.Single<IAssetLoader>()));
            _services.Single<IFactories>().Add<IEnemyFactory>(new EnemyFactory(_services.Single<IAudioService>(),
                _services.Single<IAssetLoader>()));

            _services.RegisterSingle<IInputService>(new InputService());

            _services.RegisterSingle<IScoreCounter>(new ScoreCounter(_services.Single<IFactories>(),
                _services.Single<IProgressService>(), _services.Single<IStaticDataService>()));
